...
import com.example.yatra.JSONSchemas.CategoryBikes.Bikes;
import com.example.yatra.R;
import com.example.yatra.activity.BikedetailsActivity;

import java.util.List;

public class Citybikeadapter  extends RecyclerView.Adapter<Citybikeadapter.myviewholder> {
    List<com.example.yatra.JSONSchemas.CategoryBikes.Bikes> items;
    Context context;

    public Citybikeadapter(List<com.example.yatra.JSONSchemas.CategoryBikes.Bikes> items, Context context) {
        this.items = items;
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Citybikeadapter.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        final com.example.yatra.JSONSchemas.CategoryBikes.Bikes temp = items.get(position);
