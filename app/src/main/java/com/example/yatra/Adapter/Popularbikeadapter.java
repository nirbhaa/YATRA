...
public class Popularbikeadapter extends RecyclerView.Adapter<Popularbikeadapter.myviewholder> {
    List<Bike> items;
    Context context;

    public Popularbikeadapter(List<Bike> items, Context context) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        ...
        final Bike temp = items.get(position);
       ...
       // holder.bikephoto.setImageResource(items.get(position).getProductImage());
        ...
        holder.booknow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("bikeid", temp.getId().toString());
...
//        holder.bikephoto.setOnClickListener((new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent i = new Intent(context, CityBikeActivity.class);
//                context.startActivity(i);
//            }
//        }));
